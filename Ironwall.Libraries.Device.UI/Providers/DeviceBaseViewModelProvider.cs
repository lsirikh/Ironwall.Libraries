...
namespace Ironwall.Libraries.Device.UI.Providers
{
    /****************************************************************************
        Purpose      :                                                           
        Created By   : GHLee                                                
        Created On   : 6/9/2023 9:43:23 AM                                                    
        Department   : SW Team                                                   
        Company      : Sensorway Co., Ltd.                                       
        Email        : lsirikh@naver.com                                         
     ****************************************************************************/

    public abstract class DeviceBaseViewModelProvider<T>
         : BaseCommonProvider<T>, ILoadable where T : IDeviceViewModel
    {
        #region - Ctors -
        public DeviceBaseViewModelProvider()
        {
            ClassName = nameof(DeviceBaseViewModelProvider<T>);
        }
        #endregion
