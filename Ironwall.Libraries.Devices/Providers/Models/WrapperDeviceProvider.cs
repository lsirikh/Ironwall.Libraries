...
namespace Ironwall.Libraries.Devices.Providers.Models
{
    /****************************************************************************
       Purpose      :                                                          
       Created By   : GHLee                                                
       Created On   : 6/17/2024 4:03:03 PM                                                    
       Department   : SW Team                                                   
       Company      : Sensorway Co., Ltd.                                       
       Email        : lsirikh@naver.com                                         
    ****************************************************************************/
    public abstract class WrapperDeviceProvider<T> : BaseProvider<T>, ILoadable where T: IBaseDeviceModel
    {

        #region - Ctors -
        public WrapperDeviceProvider(DeviceProvider provider)
        {
            ClassName = nameof(WrapperDeviceProvider<T>);
            _provider = provider;
