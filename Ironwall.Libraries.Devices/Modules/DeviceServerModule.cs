...
namespace Ironwall.Libraries.Devices.Modules
{
    /****************************************************************************
       Purpose      :                                                          
       Created By   : GHLee                                                
       Created On   : 7/4/2024 10:35:36 AM                                                    
       Department   : SW Team                                                   
       Company      : Sensorway Co., Ltd.                                       
       Email        : lsirikh@naver.com                                         
    ****************************************************************************/
    public class DeviceServerModule : Module
    {
        #region - Ctors -
        public DeviceServerModule(ILogService log = default, int count = default)
        {
            _log = log;
            _count = count;
        }
        ...
        protected override void Load(ContainerBuilder builder)
        {
            try
            {
                ...
                builder.RegisterType<DeviceDbService>().As<DeviceDbService>()
                    .As<IDeviceDbService>().As<IService>().SingleInstance().WithMetadata("Order", _count++); ;
