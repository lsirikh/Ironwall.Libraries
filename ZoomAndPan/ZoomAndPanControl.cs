...
namespace ZoomAndPan
{
    ...
    public partial class ZoomAndPanControl : ContentControl, IScrollInfo
    {
        ...
        /// ######################################################################################
        /// ###There are some bugs in this method for locating the contentRect Point correctly.###
        /// ######################################################################################
        /// </summary>
        public void AnimatedZoomTo(double newScale, Rect contentRect)
        {
            AnimatedZoomPointToViewportCenter(newScale, new Point(contentRect.X + (contentRect.Width / 2), contentRect.Y + (contentRect.Height / 2)),
                delegate(object sender, EventArgs e)
                {
                    ...
                    //this.ContentOffsetX = contentRect.X - contentRect.Width / 2;
                    //this.ContentOffsetY = contentRect.Y - contentRect.Height / 2;
                    //this.ContentScale = newScale;
                    Debug.WriteLine($"(ContentOffsetX, ContentOffsetY) => ({ContentOffsetX}, {ContentOffsetY})");
                });
        }
